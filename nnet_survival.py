...
class PropHazards(Layer):
    ...
    #--added by Shashank (xinformatics.github.io)------ this is useful when loading the best model- without this best saved model won't load
    def get_config(self):
        # For serialization with 'custom_objects'
        config = super(PropHazards, self).get_config()
